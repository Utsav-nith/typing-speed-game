const paragraphs=["The sun is a star located at the center of our solar system. It is the largest and most massive object in the solar system, accounting for about 99.86% of the total mass. The sun provides light and heat to the Earth, and its gravitational pull helps to keep the planets in their orbits.",
...
const totalaccuracy  =document.querySelector('.accuracy .txt2');
...
pg.querySelectorAll('span')[0].add('active');
